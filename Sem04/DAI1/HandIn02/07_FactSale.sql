...
left join AdventureWorksDwh.edw.Dim_Employee as e
on e.SalesPersonId = f.EmployeeId
left join AdventureWorksDwh.edw.Dim_Customer as c
on  f.CustomerId=c.CustomerId
left join AdventureWorksDwh.edw.Dim_Product as p
on  f.ProductId = p.ProductId
left join AdventureWorksDwh.edw.Dim_Date as sd
on  sd.Date= f.ShippingDate
left join AdventureWorksDwh.edw.Dim_Date as od
